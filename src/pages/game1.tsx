...
const Game: FC = ({ }) => {
    ...
    const [isExplanation1Displayed, setIsExplanation1Displayed] = useState<boolean>(true);
    const [isExplanation2Displayed, setIsExplanation2Displayed] = useState<boolean>(false);
    ...
    const Explanation1 = () => {
        return (
            <div className="flex flex-col items-center justify-center min-h-[calc(100vh-140px)]">
                <div>
                    <p>For the first game you will be given 39 balloons. You can pump a baloon at most 9 times before it will blow up. For each pump you will get 10 cents. You can cash in the money for each balloon whenever you want or you may continue with blowing it at your own risk :)</p>
                    <p>Good luck!</p>
    ...
    const Explanation2 = () => {
        return (
            <div className="flex flex-col items-center justify-center min-h-[calc(100vh-140px)]">
                <div>
                <h1 className="m-auto text-3xl font-extrabold leading-none tracking-tight text-green-600 dark:text-green-400">Well done!</h1>
                    <Button className="mt-[20px]" onClick={goToChallenge2}>Next challenge</Button>
                </div>
            </div>
        )
    };
    ...
    return (
        <main className="mt-10 flex flex-col items-center justify-center">
            ...
            {(isDisplayedPopGame == true) && <div className="relative border-4">
